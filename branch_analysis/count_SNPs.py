...
def main(dataset):
    ...
    annotated_tree = pd.read_csv(f'../data/POPULATION_BASED/{dataset}/annotated_tree_cleaned.csv')
    ...
    # Export results
    mutation_counter_df.to_csv(f'../data/POPULATION_BASED/{dataset}/SNP_count.csv', index=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Count SNPs and synonymous mutations in annotated_tree_cleaned.csv')
